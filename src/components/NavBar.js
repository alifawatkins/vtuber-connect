...
function NavBar({ user, setUser, selfProfile, navSelected, setNavSelected }) {
  const handleLogOut = () => {
    logOut();
    setUser(null);
  };
  ...
  return (
    <nav>
      ...
      <div className="nav-links">
        ...
        <img alt="avatar" className="nav-avatar-thumbnail" src="https://upload.wikimedia.org/wikipedia/commons/8/89/Portrait_Placeholder.png?20170328184010" />
      </div>
    </nav>
  );
}
